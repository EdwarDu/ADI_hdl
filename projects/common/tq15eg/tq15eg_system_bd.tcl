...
source $ad_hdl_dir/projects/common/tq15eg/tq15eg_preset.tcl
set_property -dict [apply_preset sys_ps8] [get_bd_cells sys_ps8]
# apply_preset [get_bd_cells sys_ps8]
